...
const SearchManufacturer = ({manufacturer,setManufacturer}:setManufacturerProps) => {
  ...
  return (
    <div className='search-manufacturer'>
        ...
        <Combobox
        // inoder to pass this data we need to update the state
        value={manufacturer}
            ...
            <div className='relative w-full'>
              ...
              onChange= {(e)=> setquery(e.target.value)}
               ...
               afterLeave={()=> setquery('')}>
                ...
                <Combobox.Options>
                  {/* this is the case when we dont have anything that the user is searching */}
                  {filteredManufacturers.length === 0 && query !== "" ? (
                   <Combobox.Option
                     value={query}
                     className="search-manufacturer__option"
                   >
                     No manufacturers found for "{query}"
                   </Combobox.Option>
                ) : (
